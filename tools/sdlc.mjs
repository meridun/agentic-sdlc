 ...
 *
 * Commands (dispatcher-side; each a pure function of gh/git state):
 ...
 *   sdlc git-maint                    fetch, ff default branch, prune merged branches, PR state
...
export const PROD_BRANCH = 'master'; // adapt to your repo (e.g. 'release')
...
/** Ordered pipeline stages. Drop 'design' here if you fold design into intake. */
