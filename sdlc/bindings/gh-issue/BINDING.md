...
no hierarchy links, no routing markers, no contract-ready handshake (`docs/Composability.md` VP2).
...
line. Existing prose dependencies migrate once with `sdlc deps --migrate` (`docs/Adoption.md`).
